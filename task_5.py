...
class Pen(Stationery):
    def draw(self):
        return print(f"Взят {self.title} запуск отрисовки ручкой")
class Pencil(Stationery):
    def draw(self):
        return print(f"Взят {self.title} запуск отрисовки карандашем")
class Handle(Stationery):
    def draw(self):
        return print(f"Взят {self.title} запуск отрисовки маркером")
